...
<html>
  <head>
    ...
    <title>Nhà tuyển dụng đã đánh giá CV của bạn</title>
  </head>
          ...
          <table role="presentation" width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 10px; padding: 20px; box-shadow: 0px 2px 10px rgba(0, 0, 0, 0.1);">
            ...
            <tr>
              <td style="padding: 20px; text-align: left; color: #333333; font-size: 16px;">
                ...
                <p>Chúng tôi vui mừng thông báo rằng nhà tuyển dụng <strong>${recruiterName}</strong> từ công ty <strong>${companyName}</strong> đã đánh giá CV của bạn cho vị trí <strong>${jobTitle}</strong> là <strong>${status}</strong>.</p>
