...
import { banner, bannerChild, flash } from "../../assets/images";
    ...
    <>
      ...
      <Container className="container mx-auto pt-14">
        <Box className="flex items-center justify-between pb-8">
          <h1 className="font-ClashDisplay font-semibold text-3xl flex gap-3 items-center text-neutrals-100">
            <img src={flash} alt="" className="h-8" />
            <span>
            ...
            {categories?.map((category) => {
              return (
                <Link
                  ...
                  className="col-span-12 md:col-span-6 bg-white  lg:col-span-3 border rounded-sm overflow-hidden"
                >
      ...
      <Box className="bg-white bg-banner rounded-t-3xl bg-no-repeat bg-contain bg-right">
        <Container className="py-10 mt-4">
          <Box className="flex items-center justify-between pb-8">
            <h1 className="font-ClashDisplay font-semibold text-3xl text-neutrals-100">
          ...
          <Box className="grid grid-cols-12 gap-6">
            {dataConvert?.map((item) => (
              ...
              >
                <Box className="p-5 flex flex-col gap-5 border rounded-sm hover:shadow-lg hover:border-primary bg-slate-100 transition-all duration-200 overflow-hidden">
                  ...
                  <Box className="flex flex-col">
                    ...
                    <span className="text-neutrals-60 truncate">
                      {item?.company?.name}
                    </span>
