const ChangePasswordUi = (resetLink, name) => {
  return `<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8" />
      ...
      <tr>
        <td align="center">
          <table role="presentation" width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 10px; padding: 20px; box-shadow: 0px 2px 10px rgba(0, 0, 0, 0.1);">
            ...
            <tr>
              <td align="center">
                <h2 style="color: #333333; margin: 0;">Yêu cầu đặt lại mật khẩu</h2>
                <p style="color: #555555; font-size: 16px; margin: 10px 0;">Chúng tôi nhận được yêu cầu đặt lại mật khẩu của bạn.</p>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding: 20px;">
                <a href="${resetLink}" style="background-color: #4527a0; color: #ffffff; padding: 12px 24px; font-size: 16px; text-decoration: none; border-radius: 5px; display: inline-block;">
                  Đặt lại mật khẩu
                </a>
              </td>
            </tr>
            ...
            <tr>
              <td align="center" style="padding: 20px; font-size: 14px; color: #888888;">
                ...
                <p style="font-size: 12px; color: #aaaaaa;">Bạn nhận được email này vì đã yêu cầu đổi mật khẩu trên nền tảng của chúng tôi.</p>
              </td>
            </tr>
...
module.exports = ChangePasswordUi;
