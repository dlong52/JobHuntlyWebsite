      ...
      <Box className="p-4 flex flex-col gap-4 min-w-[300px]">
        <Box className="flex gap-4">
          ...
          <Box className="flex flex-col">
            <span className="text-primary font-semibold">Nguyễn Đức Long</span>
            <span className="text-gray-500 text-sm">dlong.work@gmail.com</span>
          </Box>
        </Box>
        <Divider />
        <MenuList
        ...
        >
          <MenuItem onClick={()=>{navigate(RouteBase.HRProfile)}}>
