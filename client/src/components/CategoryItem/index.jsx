...
const CategoryItem = ({ data, loading }) => {
  ...
  return (
    <div className="p-6 flex flex-col gap-6 group hover:bg-primary transition-all duration-500">
      <div className="">
        <img
          src={data?.icon}
          alt=""
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="font-Epilogue text-[15px] text-primary flex gap-4 group-hover:text-white">
